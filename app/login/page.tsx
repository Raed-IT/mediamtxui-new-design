...
export default function LoginPage() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      // Force a full page reload so the auth cookie is available
      // before middleware checks /dashboard.
    ...
    <main className="login-shell">
      <section className="login-visual">
        <div className="dock-brand" style={{ zIndex: 2 }}>
          ...
          <div>
            <b>StreamOps</b>
            <small>MediaMTX Control Room</small>
          </div>
        </div>
        ...
        <div className="login-title">
          <span className="badge">
            <ShieldCheck size={13} /> Secure Operations
          </span>

          <h1>
            Monitor drones like a control room, not an admin panel.
          </h1>

          <p>
            City-based access, role permissions, live-only MediaMTX streams,
            recording, snapshots, and a cleaner command-center experience.
          </p>
        </div>
        ...
        <div className="grid grid-2" style={{ zIndex: 2 }}>
          ...
          >
            <b>Live Grid</b>
            <p style={{ color: '#d8e5df' }}>
              Auto-fill and fast operator controls.
            </p>
          </div>
      ...
      <section className="login-panel-wrap">
        <form onSubmit={submit} className="card login-card stack">
          ...
          <p className="muted" style={{ fontSize: 12 }}>
            Default seed: superadmin@test.com / 123456
          </p>
        </form>
      </section>
    </main>
